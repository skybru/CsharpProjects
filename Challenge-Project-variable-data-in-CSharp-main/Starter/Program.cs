...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogSearchArray = dogCharacteristic.Split(", ");

            //questo aggiunto dopo aver finito è per migliorare lo split per "," e non per ", "
            for (int i = 0; i < dogSearchArray.Length; i++) {
                dogSearchArray[i] = dogSearchArray[i].Trim();
            }

            Array.Sort(dogSearchArray);
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string characteristic in dogSearchArray) {
                    ...
                    // #5 update "searching" message to show countdown 
                        ...
                        {
                            Console.Write($"\rsearching...{characteristic.Trim()} for {ourAnimals[i, 3]} {icon} {j.ToString()}");
                            Thread.Sleep(100);
                        }
                    ...
                    // #3a iterate submitted characteristic terms and search description for each term
                        ...
                        if (dogDescription.Contains(characteristic)) {
                            ...
                            string dogName = ourAnimals[i, 3].Remove(0, "Nickname: ".Length);
