...
for (int i = 0; i < maxPets; i++)
{
    ...
    if (!decimal.TryParse(animalSuggestedDonation, out decimalDonation)) {
        decimalDonation = 45.00m; //default to 45.00 if not a number
    }
